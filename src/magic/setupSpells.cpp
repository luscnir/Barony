...
void setupSpells()   ///TODO: Verify this function.
{
	...
	spellElement_deathCoil.mana = 45;
	spellElement_deathCoil.base_mana = 45;
	spellElement_deathCoil.overload_multiplier = 2;
	spellElement_deathCoil.damage = 150;
	spellElement_deathCoil.duration = 0;
	strcpy(spellElement_deathCoil.name, language[4249]);
	...
	strcpy(spell_deathCoil.name, language[4249]);
	spell_deathCoil.ID = SPELL_DEATHCOIL;
	spell_deathCoil.difficulty = 100;
