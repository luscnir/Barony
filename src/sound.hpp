...
extern FMOD_SOUND** burgmusic;
#define NUMBURGMUSIC 2
extern FMOD_SOUND* crypticspiralmusic;
extern FMOD_SOUND* matildasforestmusic;
extern FMOD_SOUND** tundramusic;
#define NUMTUNDRAMUSIC 3
extern FMOD_SOUND** icedungmusic;
