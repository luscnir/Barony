...
OPENAL_BUFFER** burgmusic = NULL;
OPENAL_BUFFER* crypticspiralmusic = NULL;
OPENAL_BUFFER* matildasforestmusic = NULL;
OPENAL_BUFFER** tundramusic = NULL;
OPENAL_BUFFER* snowtownmusic = NULL;
OPENAL_BUFFER** icedungmusic = NULL;
OPENAL_BUFFER* catedralmusic = NULL;
OPENAL_BUFFER** catacombsmusic = NULL;
OPENAL_BUFFER** fleshmusic = NULL;
OPENAL_BUFFER* othersecretmusic = NULL;
OPENAL_BUFFER* prenecropolismusic = NULL;
OPENAL_BUFFER* necropolismusic = NULL;
OPENAL_BUFFER** abyssmusic = NULL;
OPENAL_BUFFER** emptymusic = NULL;
OPENAL_BUFFER* preabyssbossmusic = NULL;
OPENAL_BUFFER** antnestmusic = NULL;
OPENAL_BUFFER* vaultmusic = NULL;
OPENAL_BUFFER** farmmusic = NULL;
OPENAL_BUFFER** islandmusic = NULL;
OPENAL_BUFFER** wormsmusic = NULL;
OPENAL_BUFFER* posabyssbossmusic = NULL;
OPENAL_BUFFER* abyssbossmusic = NULL;
OPENAL_BUFFER** factorymusic = NULL;
OPENAL_BUFFER** lostmusic = NULL;
