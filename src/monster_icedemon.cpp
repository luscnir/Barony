...
void initIceDemon(Entity* my, Stat* myStats)
{
	...
	// torso
	Entity* entity = newEntity(1200, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	...
	entity->focalx = limbs[ICEDEMON][1][0]; // 0
	entity->focaly = limbs[ICEDEMON][1][1]; // 0
	entity->focalz = limbs[ICEDEMON][1][2]; // 0
	entity->behavior = &actIceDemonLimb;
	...
	// right leg
	entity = newEntity(1199, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ICEDEMON][2][0]; // 1
	entity->focaly = limbs[ICEDEMON][2][1]; // 0
	entity->focalz = limbs[ICEDEMON][2][2]; // 5
	entity->behavior = &actIceDemonLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left leg
	entity = newEntity(1197, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ICEDEMON][3][0]; // 1
	entity->focaly = limbs[ICEDEMON][3][1]; // 0
	entity->focalz = limbs[ICEDEMON][3][2]; // 5
	entity->behavior = &actIceDemonLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// right arm
	entity = newEntity(1198, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ICEDEMON][4][0]; // -.25
	entity->focaly = limbs[ICEDEMON][4][1]; // 0
	entity->focalz = limbs[ICEDEMON][4][2]; // 4
	entity->behavior = &actIceDemonLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left arm
	entity = newEntity(1196, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ICEDEMON][5][0]; // -.25
	entity->focaly = limbs[ICEDEMON][5][1]; // 0
	entity->focalz = limbs[ICEDEMON][5][2]; // 4
	entity->behavior = &actIceDemonLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// jaw
	entity = newEntity(1195, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ICEDEMON][6][0]; // 1.5
	entity->focaly = limbs[ICEDEMON][6][1]; // 0
	entity->focalz = limbs[ICEDEMON][6][2]; // 1
	entity->behavior = &actIceDemonLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
		...
		if (bodypart == LIMB_HUMANOID_RIGHTLEG || bodypart == LIMB_HUMANOID_LEFTARM)
		{
			...
			if (bodypart == LIMB_HUMANOID_RIGHTLEG || my->monsterAttack == 0)
			{
				...
				if (dist > 0.1)
				{
					...
					{
						entity->pitch -= dist * ICEDEMONWALKSPEED;
